...
import TableInvenPurchases from '../../components/inventory/TableInvenPurchases'
...
const InventoryPurchases = (props) => {
  ...
  useEffect(()=>{
    getInventorypro();
      ...
      //       data.Product.name.toLowerCase().includes(searchTerm.toLowerCase()) 

      //     )
      //       // usuario.DetailShoppings.some((data) =>
      //       //   data.subtotal.toString().includes(searchTerm.toString()) ||
      //       //   data.Product.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
      //       //   data.Product.code_product.toString().includes(searchTerm.toString())
      ...
      <div className="container-fluid mt-4">
        ...
        <div className="row mt-4">
          <div className="col-md-12">
            ...
            <TableInvenPurchases data={visibleUsuarios}/>
