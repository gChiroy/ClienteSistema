...
import { TableSale } from '../components/sales/TableSale'
import ModalAddS from '../components/sales/ModalAddSale'
import ModalEditS from '../components/sales/ModalEditSale'
      ...
      if (sales.length > 0) {
        if (searchTerm === null) {
          ...
          const filtered = sales.filter(
            (usuario) =>
            usuario?.proforma_number.toString().includes(searchTerm.toLowerCase()) ||
    ...
    <div className={isOpen ? 'wrapper' : 'side'}>
      <div className="container-fluid mt-4">
        <div className="row p-2">
          ...
          <div className="col-lg-5 col-md-12 order-2 order-lg-2">{/* BUSCADOR */}
        ...
        <div className="row p-2 ">
          ...
          <div className="col-8 d-flex justify-content-end">
            {/* <ModalAddP  Update={getPurchases}/> */}
            <ModalAddS Update={getSales}/>
          </div>
        </div>
        ...
        <div className="row mt-4">
          <div className="col-md-12">
            ...
            <ModalEditS 
            shoppingId={selectedSaleId}
            Update={getSales}
            isOpen={isModalOpen}
            toggle={toggleModalEdit}
            />
            <ModalDeleteSale 
            shoppingId={selectedSaleIdD}
            Update={getSales}
            modalOpen={isOpenDel}
