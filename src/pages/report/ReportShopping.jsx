...
import { TableReportShopping } from '../../components/report/TableReportShopping'
import { ReportPdfShopping } from '../../components/PDF/reports/shopping'
import ModalReportShopping from '../../components/PDF/reports/shopping/ModalReportShopping'
import ModalReportShoopWeek from '../../components/PDF/reports/shopping/ModalReportShoopWeek'
import ModalReportShoopMonth from '../../components/PDF/reports/shopping/ModalReportShoopMonth'
    ...
    <div className={isOpen ? 'wrapper' : 'side'}>
      <div className="container-fluid mt-4">
        <div className="row p-2">
          <div class="col-lg-7 d-flex col-md-12 order-2 order-lg-1"> 
          <div
