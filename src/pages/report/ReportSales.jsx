...
import { TableReportSales } from '../../components/report/TableReportSales'
import { ReportPdfSales } from '../../components/PDF/reports/Sales'
import { ModalSpinner } from '../../providers/ModalSpinner'
import ModalReportSale from '../../components/PDF/reports/sale/ModalReportSale'
import ModalReportSaleWeek from '../../components/PDF/reports/sale/ModalReportSaleWeek'
import ModalReportSaleMonth from '../../components/PDF/reports/sale/ModalReportSaleMonth'
      ...
      if (sales.length > 0) {
        if (searchTerm === null) {
          ...
          const filtered = sales.filter(
            (usuario) =>
            usuario?.proforma_number.toString().includes(searchTerm.toString()) ||
              usuario?.total.toString().includes(searchTerm.toString()) 
          )
