...
const  ModalReportShopping = ( props) => {
...
//     setLoading(true);
//     // const filename = 'invoice-' + selectedProduct.bill_number; // Nombre del archivo PDF
//     const url = `${URL}/api/pdfpday/pdf?date=${selectedDate}`;
...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const response = await fetch(`${URL}/api/pdfpday/pdf?date=${formattedDate}`, {
        method: 'GET',
        credentials:'include'
    });
...
export default ModalReportShopping;
