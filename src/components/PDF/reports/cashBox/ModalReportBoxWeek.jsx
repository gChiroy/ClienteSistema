...
const  ModalReportBoxWeek = ( props) => {
...
const generarPdf = () => {//http://localhost:5188/api/pdf/reportweek
    setLoading(true);
    const url = `${URL}/api/selectedweekboxpdf?week=${weekNumber}&month=${month}`;
...
export default ModalReportBoxWeek;
